...
<p>
  Este es un repositorio que almacena los archivos de la página de lyrics de la canción Mic Drop de BTS. 
  🎶 Aquí encontrarás el código necesario para mostrar la letra de la canción de forma clara y organizada. 
  🎤 Además, este proyecto puede servir como base para crear páginas similares de letras de canciones, ayudando 
  a quienes deseen aprender a desarrollar proyectos web con un enfoque musical. 🎧
</p>
...
1. **Clonar el Repositorio**
    ```bash
    git clone https://github.com/Bredalis/LyricsMicDrop.git
    cd LyricsMicDrop
    ```
